/**
 * Kotlin source for AlarmWakeActivity — opaque native full-screen UI that appears
 * instantly on the lock screen while React Native loads the ring screen.
 */
